...
namespace Symposium.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            AddToRoleViewModel addToRoleViewModel = new AddToRoleViewModel();
            addToRoleViewModel.Roles = new System.Collections.Generic.List<string>();
            addToRoleViewModel.Roles.Add("Administrator");
            addToRoleViewModel.Roles.Add("User");

            return View(addToRoleViewModel);
        }

        public ActionResult AddRolePOST(AddToRoleViewModel addToRoleViewModel)
        {
            var email = addToRoleViewModel.UserEmail;
            var role = addToRoleViewModel.Role;
